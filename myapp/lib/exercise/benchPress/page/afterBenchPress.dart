...
import 'package:myapp/exercise/benchPress/page/finalBenchPress.dart';
import '../component/benchPressImage.dart';
import '../component/dataInput.dart';
import './exerciseBenchPress.dart';
...
class AfterBenchPress extends StatelessWidget{
          ...
          Row(
           ...
           ElevatedButton(
            onPressed: (){
              Navigator.push(
                context,
                 MaterialPageRoute(builder: (context)=> FinalBenchPress())
                );
            },
