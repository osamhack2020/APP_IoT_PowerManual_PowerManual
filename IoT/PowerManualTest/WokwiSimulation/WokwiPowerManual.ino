// 스쿼트자세 측정완료 + 운동상태 LED
// https://wokwi.com/arduino/projects/312524496739238465
...
int squat = 1;
int exercise  = 1;  //앱으로 부터 어떤 운동을 수행할지 전달받는 변수; 처음 값은 0 지금은 squat 시연용이어서 1
int reps = 5; // 운동횟수; 처음 값은 0 지금은 squat 시연용이어서 5
